    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <Section title="Buttons">
        ...
        <SubSection title="Icon buttons">
          <div className="flex items-center gap-2 flex-wrap">
            <Button variant="ghost" size="icon-xs" aria-label="Search small"><Search /></Button>
            <Button variant="ghost" size="icon-sm" aria-label="Search medium"><Search /></Button>
            <Button variant="outline" size="icon" aria-label="Search large"><Search /></Button>
            <Button variant="outline" size="icon-lg" aria-label="Search extra large"><Search /></Button>
          </div>
        </SubSection>
